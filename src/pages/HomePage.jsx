      ...
      <div className="overflow-x-hidden">
        <div className=" col-span-12 lg:col-span-10  px-5 pb-4 ">
          ...
          <div className="flex justify-end  items-start p-4 w-full">
            <span className="text-white text-lg md:text-xl lg:text-1xl cursor-pointer hover:underline px-4 py-2 bg-yellow-400 rounded-lg transition duration-300">
        ...
        <div className="p-2 md:p-2  bg-gray-50 text-gray-800">
          ...
          <p className="text-sm">
            ...
            good collection of Sidney Sheldon or some editions of classics or
            the Dan Brown creative, you name it, it’s featured in the Amazon
            list. Grab your favourite book right away.
          </p>
          ...
          <p className="text-sm">
            Action and adventure books have always been a favourite to most of
            us, especially during our childhood days when the fantasies knew no
            ...
            your child to your childhood adventure books and let their
            imagination run wild. Continue your passion for action and adventure
            books and expand your collection by buying online at Amazon.in.
          </p>
          ...
          <p className="text-sm">
            The collection of action and adventure books available at Amazon.in
            is wide and includes an exclusive list of books at discounted rates.
            Moreover, you get an amazing collection in various other languages,
            including Spanish, French, German, Italian, etc. There’s no way
            you’ll run out of choices from the extensive range of action and
            adventure books.
          </p>
          ...
          <p className="text-sm">
            ...
            formats. Kindle versions of most of the books can be grabbed either
            at really low prices or absolutely free of cost. Narrow down your
            search based on the formats available, including board book, Kindle
            eBooks, paperback, audiobook, pocket book, bundle, loose leaf, etc.
            Find your favourite author and narrow down your search further to
            find what you want. Avail cash on delivery on most of the books
            available. If you are looking for books on heavy discounts, you
            won’t be disappointed either. At Amazon.in, you can avail books at
            discount rates of 10%, 25%, 35% and even 50% or more. Whatever your
            budget, Amazon.in offers you a great deal on your favourite action
            and adventure books.
          </p>
        </div>
      </div>
